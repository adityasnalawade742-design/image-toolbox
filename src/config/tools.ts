...
export const TOOLS: ToolDefinition[] = [
  ...
  },
  {
    ...
    shortName: 'Filters',
    description: 'Apply aesthetic color presets, brightness, contrast, saturation, vignette, and vintage film grain effects.',
    category: 'edit-transform',
    iconName: 'Sliders',
    accept: 'image/png,image/jpeg,image/webp',
    popular: true,
  },
  {
    ...
    description: 'Create viral memes with customizable top/bottom Impact captions, outline colors, and stickers.',
    category: 'edit-transform',
    iconName: 'Smile',
    accept: 'image/png,image/jpeg,image/webp',
    popular: true,
  },
  {
    ...
    description: 'Cut photos into Instagram 3×3 grids, panoramic carousel slices, and custom tile matrices with 1-click ZIP download.',
    category: 'edit-transform',
    iconName: 'Grid',
    accept: 'image/png,image/jpeg,image/webp',
    popular: true,
  },
  {
    ...
    description: 'Redact sensitive information, faces, license plates, and private numbers with Gaussian blur, mosaic pixelation, or blackout bars.',
    category: 'edit-transform',
    iconName: 'EyeOff',
    accept: 'image/png,image/jpeg,image/webp',
    popular: true,
