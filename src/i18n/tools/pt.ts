...
export const ptTools: Record<string, LocalizedToolItem> = {
  'crop-image': {
    ...
    "keywords": [
        ...
        "cortar foto em circulo",
        "crop imagem online"
    ],
    "howToSteps": [
        {
            "title": "Carregue sua foto",
            "description": "Arraste a imagem para a área de edição."
        },
        {
            "title": "Defina o enquadramento",
            "description": "Escolha a proporção desejada ou ajuste livremente."
        },
        {
            "title": "Baixe a foto",
            "description": "Clique em Baixar para salvar a imagem recortada."
        }
    ],
    "features": [
        "100% Privado no Navegador",
        "Proporções 1:1, 16:9, 4:3 e Avatar Circular",
        "Rotação e espelhamento",
        "Exportação nítida"
    ],
    "faqs": [
        {
            "question": "Minhas imagens vão para a nuvem?",
            "answer": "Não. Todo o processo roda no seu navegador com HTML5 Canvas."
        }
    ]
},
  'resize-image': {
    ...
    "keywords": [
        ...
        "mudar tamanho foto",
        "alterar pixels imagem",
        "escalar foto gratis"
    ],
    "howToSteps": [
        {
            "title": "Envie a imagem",
            "description": "Selecione sua foto no dispositivo."
        },
        {
            "title": "Defina as medidas",
            "description": "Digite a largura, altura ou porcentagem."
        },
        {
            "title": "Baixe o resultado",
            "description": "Salve a foto redimensionada."
        }
    ],
    "features": [
        "Ajuste por pixels ou %",
        "Bloqueio de proporção",
        "Sem upload",
        "Alta velocidade"
    ],
    "faqs": [
        {
            "question": "Como não distorcer a imagem?",
            "answer": "Mantenha a opção de bloquear proporção ativada."
        }
    ]
},
  'compress-image': {
    ...
    "howToSteps": [
        {
            ...
            "description": "Arraste a foto para o compressor."
        },
        {
            "title": "Ajuste a compressão",
            "description": "Mova o controle deslizante de qualidade."
        },
        {
            "title": "Baixe otimizada",
            "description": "Baixe o arquivo com tamanho reduzido."
        }
    ],
    "features": [
    ...
    "faqs": [
        {
            "question": "Qual formato economiza mais espaço?",
            "answer": "O formato WebP reduz até 50% mais que JPEG com qualidade visual similar."
        }
    ]
},
  'rotate-image': {
  ...
  'convert-image': {
    ...
    "seoTitle": "Image Converter Online Free (PT) — Image Toolbox",
  ...
  'jpg-to-png': {
    ...
    "seoTitle": "JPG to PNG Online Free (PT) — Image Toolbox",
  ...
  'png-to-jpg': {
    ...
    "seoTitle": "PNG to JPG Online Free (PT) — Image Toolbox",
  ...
  'jpg-to-webp': {
    ...
    "seoTitle": "JPG to WebP Online Free (PT) — Image Toolbox",
  ...
  'png-to-webp': {
    ...
    "seoTitle": "PNG to WebP Online Free (PT) — Image Toolbox",
  ...
  'webp-to-jpg': {
    ...
    "seoTitle": "WebP to JPG Online Free (PT) — Image Toolbox",
  ...
  'webp-to-png': {
    ...
    "seoTitle": "WebP to PNG Online Free (PT) — Image Toolbox",
  ...
  'bulk-image-resizer': {
    ...
    "seoTitle": "Bulk Image Resizer Online Free (PT) — Image Toolbox",
  ...
  'bulk-image-compressor': {
    ...
    "seoTitle": "Bulk Image Compressor Online Free (PT) — Image Toolbox",
  ...
  'remove-image-metadata': {
    ...
    "seoTitle": "Remove Image Metadata Online Free (PT) — Image Toolbox",
  ...
  'image-color-picker': {
    ...
    "seoTitle": "Image Color Picker Online Free (PT) — Image Toolbox",
  ...
  'image-palette-generator': {
    ...
    "seoTitle": "Image Palette Generator Online Free (PT) — Image Toolbox",
  ...
  'add-text-to-image': {
    ...
    "seoTitle": "Add Text to Image Online Free (PT) — Image Toolbox",
  ...
  'watermark-image': {
    ...
    "seoTitle": "Watermark Image Online Free (PT) — Image Toolbox",
  ...
  'add-border-to-image': {
    ...
    "seoTitle": "Add Border to Image Online Free (PT) — Image Toolbox",
  ...
  'image-to-base64': {
    ...
    "seoTitle": "Image to Base64 Online Free (PT) — Image Toolbox",
  ...
  'image-to-data-uri': {
    ...
    "seoTitle": "Image to Data URI Online Free (PT) — Image Toolbox",
  ...
  'base64-to-image': {
    ...
    "seoTitle": "Base64 to Image Online Free (PT) — Image Toolbox",
  ...
  'svg-to-png': {
    ...
    "seoTitle": "SVG to PNG Online Free (PT) — Image Toolbox",
...
export function getPTTool(slug: string): LocalizedToolItem {
  return ptTools[slug] || enTools[slug];
}
