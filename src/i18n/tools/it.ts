...
export const itTools: Record<string, LocalizedToolItem> = {
  'crop-image': {
    ...
    "keywords": [
        "ritagliare immagine online",
        "tagliare foto gratis",
        "ritagliare foto cerchio",
        "crop image online"
    ],
    "howToSteps": [
        {
            "title": "Carica l’immagine",
            "description": "Trascina il file nell’area di lavoro."
        },
        {
            "title": "Regola il riquadro",
            "description": "Seleziona le proporzioni e posiziona il ritaglio."
        },
        {
            "title": "Scarica",
            "description": "Salva subito l’immagine ritagliata."
        }
    ],
    "features": [
        "100% Privacy nel Browser",
        "Rapporti 1:1, 16:9, 4:3 e Cerchio",
        "Rotazione e specchio",
        "Esportazione HD"
    ],
    "faqs": [
        {
            "question": "Le foto vengono caricate su un server?",
            "answer": "No. L’elaborazione avviene interamente sul tuo dispositivo con HTML5 Canvas."
        }
    ]
},
  'resize-image': {
    ...
    "keywords": [
        "ridimensionare immagine online",
        "cambiare risoluzione foto",
        "modificare pixel immagine",
        "scalare foto gratis"
    ],
    "howToSteps": [
        {
            "title": "Carica il file",
            "description": "Seleziona l’immagine da ridimensionare."
        },
        {
            "title": "Inserisci le dimensioni",
            "description": "Indica larghezza, altezza o percentuale."
        },
        {
            "title": "Scarica",
            "description": "Salva l’immagine ridimensionata."
        }
    ],
    "features": [
        "Pixel o percentuale",
    ...
    "faqs": [
        {
            "question": "Come evitare distorsioni?",
            "answer": "Mantieni attivo il blocco delle proporzioni."
        }
    ]
},
  'compress-image': {
    ...
    "keywords": [
        "comprimere immagine online",
        "ridurre peso foto",
        "ottimizzare immagini web",
        "comprimere jpg gratis"
    ],
    "howToSteps": [
        {
            "title": "Seleziona l’immagine",
            "description": "Trascina il file nel compressore."
        },
        {
            "title": "Regola la qualità",
            "description": "Imposta il livello di compressione desiderato."
        },
        {
            "title": "Scarica",
            "description": "Salva il file compresso."
        }
    ],
    "features": [
        "Compressione visiva ottimale",
    ...
    "faqs": [
        {
            "question": "Perché usare WebP?",
            "answer": "WebP permette di risparmiare fino al 50% di spazio rispetto al formato JPEG."
        }
    ]
},
  'rotate-image': {
    ...
    "seoTitle": "Rotate Image Online Free (IT) — Image Toolbox",
  ...
  'flip-image': {
    ...
    "seoTitle": "Flip Image Online Free (IT) — Image Toolbox",
  ...
  'convert-image': {
    ...
    "seoTitle": "Image Converter Online Free (IT) — Image Toolbox",
  ...
  'jpg-to-png': {
    ...
    "seoTitle": "JPG to PNG Online Free (IT) — Image Toolbox",
  ...
  'png-to-jpg': {
    ...
    "seoTitle": "PNG to JPG Online Free (IT) — Image Toolbox",
  ...
  'jpg-to-webp': {
    ...
    "seoTitle": "JPG to WebP Online Free (IT) — Image Toolbox",
  ...
  'png-to-webp': {
    ...
    "seoTitle": "PNG to WebP Online Free (IT) — Image Toolbox",
  ...
  'webp-to-jpg': {
    ...
    "seoTitle": "WebP to JPG Online Free (IT) — Image Toolbox",
  ...
  'webp-to-png': {
    ...
    "seoTitle": "WebP to PNG Online Free (IT) — Image Toolbox",
  ...
  'bulk-image-resizer': {
    ...
    "seoTitle": "Bulk Image Resizer Online Free (IT) — Image Toolbox",
  ...
  'bulk-image-compressor': {
    ...
    "seoTitle": "Bulk Image Compressor Online Free (IT) — Image Toolbox",
  ...
  'remove-image-metadata': {
    ...
    "seoTitle": "Remove Image Metadata Online Free (IT) — Image Toolbox",
  ...
  'image-analyzer': {
    ...
    "seoTitle": "Image Analyzer Online Free (IT) — Image Toolbox",
  ...
  'image-color-picker': {
    ...
    "seoTitle": "Image Color Picker Online Free (IT) — Image Toolbox",
  ...
  'image-palette-generator': {
    ...
    "seoTitle": "Image Palette Generator Online Free (IT) — Image Toolbox",
  ...
  'add-text-to-image': {
    ...
    "seoTitle": "Add Text to Image Online Free (IT) — Image Toolbox",
  ...
  'watermark-image': {
    ...
    "seoTitle": "Watermark Image Online Free (IT) — Image Toolbox",
  ...
  'add-border-to-image': {
    ...
    "seoTitle": "Add Border to Image Online Free (IT) — Image Toolbox",
  ...
  'round-image': {
    ...
    "seoTitle": "Round Image Online Free (IT) — Image Toolbox",
  ...
  'favicon-generator': {
    ...
    "seoTitle": "Favicon Generator Online Free (IT) — Image Toolbox",
  ...
  'image-to-base64': {
    ...
    "seoTitle": "Image to Base64 Online Free (IT) — Image Toolbox",
  ...
  'image-to-data-uri': {
    ...
    "seoTitle": "Image to Data URI Online Free (IT) — Image Toolbox",
  ...
  'base64-to-image': {
    ...
    "seoTitle": "Base64 to Image Online Free (IT) — Image Toolbox",
  ...
  'svg-to-png': {
    ...
    "seoTitle": "SVG to PNG Online Free (IT) — Image Toolbox",
...
export function getITTool(slug: string): LocalizedToolItem {
  return itTools[slug] || enTools[slug];
}
